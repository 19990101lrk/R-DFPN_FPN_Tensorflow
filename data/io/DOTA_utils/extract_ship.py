...
def extract_ship_object():
    ...
    """
    #  DOTA数据的txt文件夹
    # txtFolder = r"D:\DataSets\DOTA\DOTA-v1.5\train\labelTxt-v1.5\DOTA-v1.5_train"
    txtFolder = r"D:\DataSets\DOTA\DOTA-v1.5\val\labelTxt-v1.5\DOTA-v1.5_val"
    #  DOTA数据的image文件夹
    # imgFolder = r"D:\DataSets\DOTA\DOTA-v1.5\train\images\images"
    imgFolder = r"D:\DataSets\DOTA\DOTA-v1.5\val\images\images"
    #  要复制到的image文件夹
    # copy_imageFolder = r"D:\DataSets\R_DFPN_datasets_DOTAv1.5\train\images\images"
    copy_imageFolder = r"D:\DataSets\R_DFPN_datasets_DOTAv1.5\val\images\images"
    #  要复制到的txt文件夹
    # copy_txtFolder = r"D:\DataSets\R_DFPN_datasets_DOTAv1.5\train\labelTxt-v1.5\DOTA-v1.5_train"
    copy_txtFolder = r"D:\DataSets\R_DFPN_datasets_DOTAv1.5\val\labelTXT-v1.5\DOTA-v1.5_val"
    #  感兴趣类别
    selected_class = "ship"
...
def draw_ship_object():
    ...
    imgPath = r"D:\DataSets\R_DFPN_datasets_DOTAv1.5\val\images\images\P0019.png"
    txtPath = r"D:\DataSets\R_DFPN_datasets_DOTAv1.5\val\labelTXT-v1.5\DOTA-v1.5_val\P0019.txt"
    savePath = "obb.jpg"
    drawType = "obb"
